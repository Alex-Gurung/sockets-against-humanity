(function (e, t) {
  var n = { smoketimeout: [], init: false, zindex: 1e3, i: 0, bodyload: function (e) {
      var r = t.createElement("div");r.setAttribute("id", "smoke-out-" + e);r.className = "smoke-base";r.style.zIndex = n.zindex;n.zindex++;t.body.appendChild(r);
    }, newdialog: function () {
      var t = new Date().getTime();t = Math.random(1, 99) + t;if (!n.init) {
      ...
      n.i++;r.stack = n.i;t = t.replace(/\n/g, "<br />");t = t.replace(/\r/g, "<br />");var i = "",
          s = "OK",
          o = "Cancel",
          u = "",
          a = "",
        ...
        a = '<div class="dialog-buttons">';if (r.type === "alert") {
      ...
      }f = '<div id="smoke-bg-' + r.newid + '" class="smokebg"></div>' + '<div class="dialog smoke ' + u + '">' + '<div class="dialog-inner">' + t + i + a + "</div>" + "</div>";if (!n.init) {
        n.listen(e, "load", function () {
          n.finishbuild(t, r, f);
        });
      } else {
      ...
      var s = t.getElementById("smoke-out-" + r.newid);s.className = "smoke-base smoke-visible  smoke-" + r.type;s.innerHTML = i;while (s.innerHTML === "") {
        s.innerHTML = i;
      }if (n.smoketimeout[r.newid]) {
        clearTimeout(n.smoketimeout[r.newid]);
      }n.listen(t.getElementById("smoke-bg-" + r.newid), "click", function () {
        n.destroy(r.type, r.newid);if (r.type === "prompt" || r.type === "confirm" || r.type === "quiz") {
          r.callback(false);
        } else if (r.type === "alert" && typeof r.callback !== "undefined") {
          r.callback();
        }
      });switch (r.type) {case "alert":
          n.finishbuildAlert(e, r, i);break;case "confirm":
          n.finishbuildConfirm(e, r, i);break;case "quiz":
          n.finishbuildQuiz(e, r, i);break;case "prompt":
          n.finishbuildPrompt(e, r, i);break;case "signal":
          n.finishbuildSignal(e, r, i);break;default:
          throw "Unknown type: " + r.type;}
    }, finishbuildAlert: function (r, i, s) {
      n.listen(t.getElementById("alert-ok-" + i.newid), "click", function () {
        n.destroy(i.type, i.newid);if (typeof i.callback !== "undefined") {
          i.callback();
        }
      ...
      n.listen(t.getElementById("confirm-cancel-" + i.newid), "click", function () {
        n.destroy(i.type, i.newid);i.callback(false);
      });n.listen(t.getElementById("confirm-ok-" + i.newid), "click", function () {
        n.destroy(i.type, i.newid);i.callback(true);
      });t.onkeyup = function (t) {
        if (!t) {
          t = e.event;
      ...
      var o, u, a;n.listen(t.getElementById("quiz-cancel-" + i.newid), "click", function () {
        n.destroy(i.type, i.newid);i.callback(false);
      });if (o = t.getElementById("quiz-ok1-" + i.newid)) n.listen(o, "click", function () {
        n.destroy(i.type, i.newid);i.callback(o.innerHTML);
      });if (u = t.getElementById("quiz-ok2-" + i.newid)) n.listen(u, "click", function () {
        n.destroy(i.type, i.newid);i.callback(u.innerHTML);
      });if (a = t.getElementById("quiz-ok3-" + i.newid)) n.listen(a, "click", function () {
        n.destroy(i.type, i.newid);i.callback(a.innerHTML);
      });t.onkeyup = function (t) {
        if (!t) {
          t = e.event;
        }if (t.keyCode === 27) {
      ...
      var o = t.getElementById("dialog-input-" + i.newid);setTimeout(function () {
        o.focus();o.select();
      }, 100);n.listen(t.getElementById("prompt-cancel-" + i.newid), "click", function () {
        n.destroy(i.type, i.newid);i.callback(false);
      });n.listen(t.getElementById("prompt-ok-" + i.newid), "click", function () {
        n.destroy(i.type, i.newid);i.callback(o.value);
      });t.onkeyup = function (t) {
        if (!t) {
          t = e.event;
        }if (t.keyCode === 13) {
      ...
      var i = t.getElementById("smoke-out-" + r);if (e !== "quiz") {
        var s = t.getElementById(e + "-ok-" + r);
      }var o = t.getElementById(e + "-cancel-" + r);i.className = "smoke-base";if (s) {
        n.stoplistening(s, "click", function () {});t.onkeyup = null;
      }if (e === "quiz") {
        var u = t.getElementsByClassName("quiz-button");for (var a = 0; a < u.length; a++) {
          n.stoplistening(u[a], "click", function () {});t.onkeyup = null;
        }
      }if (o) {
      ...
      if (typeof r !== "object") {
        r = false;
      }var i = n.newdialog();n.build(e, { type: "alert", callback: t, params: r, newid: i });
    }, signal: function (e, t, r) {
      if (typeof r !== "object") {
        r = false;
      }var i = 5e3;if (r.duration !== "undefined") {
        i = r.duration;
      }var s = n.newdialog();n.build(e, { type: "signal", callback: t, timeout: i, params: r, newid: s });
    }, confirm: function (e, t, r) {
      if (typeof r !== "object") {
        r = false;
      }var i = n.newdialog();n.build(e, { type: "confirm", callback: t, params: r, newid: i });
    }, quiz: function (e, t, r) {
      if (typeof r !== "object") {
        r = false;
      }var i = n.newdialog();n.build(e, { type: "quiz", callback: t, params: r, newid: i });
    }, prompt: function (e, t, r) {
      if (typeof r !== "object") {
        r = false;
      }var i = n.newdialog();return n.build(e, { type: "prompt", callback: t, params: r, newid: i });
    ...
    } };n.init = true;if (typeof module != "undefined" && module.exports) {
    module.exports = n;
