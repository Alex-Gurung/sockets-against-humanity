...
io.sockets.on('connection', (socket) => {
    ...
    socket.on('entered room', (game_id) => {
      ...
      socket
        .broadcast
        .to(socket.room)
        .emit('update users', {game: games_list[socket.room], position: position_list[game_id]})
      ...
      socket
        .broadcast
        .to(game_id)
        .emit('update users', {game: games_list[game_id], position:position_list[game_id]})
